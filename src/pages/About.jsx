        ...
        <div className='  flex flex-col md:flex-row text-sm mb-20'>
            ...
            <div className='flex items-center justify-center border h-[250px] px-10 md:px-16 py-8 sm:py-20 flex-col'>
              <div>
                ...
                <p className='text-gray-600 mt-5'>We meticulously select and vet each product to ensure it meets our stringent quality standards.</p>
              </div>    
            </div>
            <div className='flex items-center justify-center border h-[250px] px-10 md:px-16 py-8 sm:py-20 flex-col'>
              <div>
                <b className=''>Convenience:</b>
                <p className='text-gray-600 mt-5'>With our user-friendly interface and hassle-free ordering process, shopping has never been easier.</p>
              </div>    
            </div>
            <div className='flex items-center justify-center border h-[250px] px-10 md:px-16 py-8 sm:py-20 flex-col'>
              <div>
                <b className='text-sm'>Exceptional Customer Service:</b>
                <p className='text-gray-600 mt-5'>Our team of dedicated professionals is here to assist you the way, ensuring your satisfaction is our top priority.</p>
              </div>    
            </div>
