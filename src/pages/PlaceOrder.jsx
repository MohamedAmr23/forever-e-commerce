  ...
  return (
    <div className="flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t">
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <input required type="text" name='lastName' className='border border-gray-300 rounded py-1.5 px-3.5 w-full' placeholder='last name'   />
        </div>
        <input required type='email' className='border border-gray-300 rounded py-1.5 px-3.5 w-full' placeholder='Email address'/>
        <input required type='text' className='border border-gray-300 rounded py-1.5 px-3.5 w-full' placeholder='Street'/>
        <div className='flex gap-3'>
          <input required type="text" name='city' className='border border-gray-300 rounded py-1.5 px-3.5 w-full' placeholder='City'   />
          <input required type="text" name='state' className='border border-gray-300 rounded py-1.5 px-3.5 w-full' placeholder='State'   />
        </div>
        <div className='flex gap-3'>
        <input required type="number" name='zipCode' className='border border-gray-300 rounded py-1.5 px-3.5 w-full' placeholder='ZipCode'   />
        <input required type="text" name='country' className='border border-gray-300 rounded py-1.5 px-3.5 w-full' placeholder='Country'   />
        </div>
